...
/// </summary>
/// <remarks>
/// The two ways DiskSpaceMon fails to start are a settings file it cannot parse and a settings file it
...
public static class StartupProblem
{
    ...
    public static string Describe(Exception exception)
    {
        ...
        {
            var report = new StringBuilder("settings.xml has values DiskSpaceMon cannot use:")
                .AppendLine()
                .AppendLine();
