...
public static class ServiceControl
{
    ...
    /// </summary>
    /// <param name="executablePath">Full path to DiskSpaceMon.exe.</param>
    ...
    public static int Install(string executablePath, TextWriter output)
    {
        ...
        output.WriteLine($"Installed '{ServiceMetadata.Name}'. Start it with: DiskSpaceMon start");
        return 0;
    }
