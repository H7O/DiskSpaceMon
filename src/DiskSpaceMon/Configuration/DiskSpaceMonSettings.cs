...
public sealed class DiskSpaceMonSettings
{
    /// <summary>
...
public sealed class EmailSettings
{
    ...
    public string SubjectAlert { get; set; } = "[DiskSpaceMon] Low disk space on {{machineName}}";

    /// <summary>Subject of a recovery notice. Rendered through the template engine.</summary>
    public string SubjectRecovery { get; set; } = "[DiskSpaceMon] Disk space recovered on {{machineName}}";
