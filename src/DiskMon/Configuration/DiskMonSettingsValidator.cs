...
/// </summary>
public sealed class DiskMonSettingsValidator : IValidateOptions<DiskMonSettings>
{
    /// <summary>The smallest sweep interval accepted.</summary>
    public const int MinimumIntervalSeconds = 5;

    /// <inheritdoc/>
    public ValidateOptionsResult Validate(string? name, DiskMonSettings options)
    {
