...
/// and DiskMon still builds and runs as a terminal application on Linux and macOS.
/// </remarks>
...
public static class WindowsHostingSetup
{
    ...
    public static void AddEventLog(HostApplicationBuilder builder)
    {
        ...
        {
            // The source is registered by 'DiskMon install', which runs elevated. Registering it
